--[[
  ...
  UI: Orion (MarV)
  Full ZiaanHub X feature integration
  Version: FINAL (all features working)
]]
...
local ParrySystem = { CooldownToken = 0, IsOnCooldown = false, IsResolving = false, Gradients = ParryGradients, Icon = ParryIcon, CooldownThread = nil, LockConnection = nil, ParryTrack = nil }
...
-- FINAL NOTIFICATION
OrionLib:MakeNotification({ Name = "NO MERCY", Content = "Violence District full features loaded!", Image = ICON.Logo, Time = 4 })
print("[NO MERCY] Violence District with full Ziaan features loaded successfully!")
